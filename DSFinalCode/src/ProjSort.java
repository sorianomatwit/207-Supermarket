...
public class ProjSort {
	...
	private static <T extends Comparable<? super T>> int alphabetical(String[] a, int first, int last)
	{
		String min = a[first];
		int indexOfMin = first;
		String longest = "";
	...
	public static void main(String[] args) {
		...
		String[] nums = {"apple", "banana", "pear", "orange", "appel"};
